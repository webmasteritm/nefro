    ...
    <section id="hero">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <!-- Slide 1 -->
                <div class="carousel-item active" style="background-image: url(../assets/img/sedes/UR-barranquilla/4.webp)">
                    <div class="container">
                ...
                <!-- Slide 2 -->
                {{-- <div class="carousel-item" style="background-image: url(../assets/img/sedes/UR-barranquilla/2.webp)">
                    <div class="container">
                        <h2><span style="color: #F57D00;">NEFROUROS</span> <span style="color: #737373;">SEDE
                                BARRANQUILLA</span></h2>
                        <a href="{{ route('citas.home') }}" class="btn-get-started scrollto">Citas en linea</a>
                ...
                <!-- Slide 3 -->
                <div class="carousel-item" style="background-image: url(../assets/img/sedes/UR-barranquilla/3.webp)">
                    <div class="container">
                        <h2><span style="color: #F57D00;">NEFROUROS</span> <span style="color: #737373;">SEDE
                                BARRANQUILLA</span></h2>
                        <a href="{{ route('citas.home') }}" class="btn-get-started scrollto">Citas en linea</a>
                ...
                <div class="row text-center">
                    <div class="row text-center">
                        <div class="col-lg-4" style="margin-bottom: 50px;">
                            <a href="https://nefrouros.net/pacientes-actividades-Barranquilla-407">
                                <img src="{{ asset('assets/img/album/barranquilla/1.jpg') }}" alt="Foto 1"
                        ...
                        <div class="col-lg-4" style="margin-bottom: 50px;">
                            <a href="https://nefrouros.net/pacientes-actividades-Barranquilla-379">
                                <img src="{{ asset('assets/img/album/barranquilla/2.jpg') }}" alt="Foto 2"
                                    style="border-radius: 10px;">
                                <p>Campaña Institucional <br>
                                    La Diálisis Es Vida, Disfruta Tu Vida</p>
                        ...
                        <div class="col-lg-4" style="margin-bottom: 50px;">
                            <a href="https://nefrouros.net/pacientes-actividades-Barranquilla-375">
                                <img src="{{ asset('assets/img/album/barranquilla/3.jpg') }}" alt="Foto 3"
                                    style="border-radius: 10px;">
                                <p>Día Mundial <br>
                                    Del Riñón</p>
                ...
                <div class="col-lg-4">
                    <div class="info">
                        <div class="address">
                            ...
                            <h4>Ubicación:</h4>
                            <p>cra 49c # 84 - 57 barrio san vicente</p>
